package application.dalem_lab_4;/* TwoDimArrayPractice
...
/*
 ...
 Summary of Description: 2D Array
 Due Date: 10/15/2024
...
public class TwoDimArrayPractice extends JFrame
{
    ...
    public void printArray( )
    {
        ...
        for (int row = 0; row < intArray.length; row++) {
            ...
            for (int column = 0; column < intArray[row].length; column++) {
                System.out.print(intArray[row][column] + " ");  // Print the value
                animate(row, column);  // Provide visual feedback while printing
            }
            System.out.println();  // Move to the next line after printing all columns of the row
        }
    ...
    public void setValues( int value, int row )
    {
        ...
        // Write your code here:
        for (int column = 0; column < intArray[row].length; column++) {
            intArray[row][column] = value;  // Set the value in the array
            animate(row, column);  // Provide visual feedback while setting the value
        }
    }
    ...
    public int findMinimum( int column )
    {
        ...
        for (int row = 1; row < intArray.length; row++) {
            if (intArray[row][column] < min) {
                min = intArray[row][column];  // Update the minimum value if a smaller value is found
            }
            animate(row, column, min);  // Provide visual feedback while searching for the minimum
        }
        return min;
    }
        ...
        for (int row = 0; row < intArray.length; row++) {
            ...
            for (int column = 0; column < intArray[row].length; column++) {
                if (intArray[row][column] == value) {
                    count++;  // Increment the counter if the value matches
                }
                animate(row, column, count);  // Provide visual feedback while counting
            }
        }
        return count;
    }
